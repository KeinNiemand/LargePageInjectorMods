...
private:
	std::unordered_map<MiMallocReplacedFunctions, sigmatch::signature> functionSignatureMap = { 
		...
		//{MiMallocReplacedFunctions::malloc,			"e9 5f 03 02 00 cc cc cc"_sig},
		{MiMallocReplacedFunctions::free_base,			"48 85 c9 74 ?? 53 48 83 ec 20 4c 8b c1 33 d2 48 8b 0d 5e b9 e4 00"_sig},
		{MiMallocReplacedFunctions::free,			"c7 44 24 10 00 00 00 00 8b 44 24 10 e9 53 4d 02 00"_sig},
		{MiMallocReplacedFunctions::realloc,		"48 89 5c 24 08 57 48 83 ec 20 48 8b da 48 8b f9 48 85 c9 75"_sig},
		//{MiMallocReplacedFunctions::realloc,		"e9 5f 25 02 00 cc cc cc"_sig},
		...
		{MiMallocReplacedFunctions::cfree,			"48 8b ca e9 18 b1 2c 00 cc cc cc cc cc cc cc"_sig},
		...
		{MiMallocReplacedFunctions::operator_new_nothrow,"48 83 ec 28 e8 eb f8 ff ff eb 02"_sig}, //Bad Sig not version compatible
