...
private:
	std::unordered_map<MiMallocReplacedFunctions, sigmatch::signature> functionSignatureMap = { 
		...
		{MiMallocReplacedFunctions::realloc,		"48 89 5c 24 08 57 48 83 ec 20 48 8b da 48 8b f9 48 85"_sig},
		{MiMallocReplacedFunctions::calloc,			"40 53 48 83 ec 20 4c 8b c2 48 8b d9 48 85 c9"_sig},
...
public:
	void* GetFunctionAdress(std::string moduleName,MiMallocReplacedFunctions function);
};
